...
# --- Planificateur ---------------------------------------------------
# Import hebdomadaire. Le fuseau vient de TZ (Europe/Paris dans le compose) :
# sans lui, APScheduler declencherait les taches en UTC.
FUSEAU = os.environ.get("TZ", "Europe/Paris")
IMPORT_JOUR = os.environ.get("VEILLE_IMPORT_JOUR", "mon")   # lundi
